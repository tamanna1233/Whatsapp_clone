          ...
          <Dragable ref={dragRef} isMinimized={isMinimized}>
                  ...
                  <div className="fixed  bottom-10 w-full ">
                        <div className="flex items-center justify-center p-2 w-full  gap-8">
                              <button onClick={handelMute} className="text-white bg-slate-900 rounded-full p-4">
                                    {isMute ? (
                              ...
                              <button onClick={handelVideo} className="text-white bg-slate-900 rounded-full p-4">
                                    {isVideo ? (
                                          <FaVideo size={25} />
                                    ) : (
